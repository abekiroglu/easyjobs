...
setFoundedDate = e => {
    this.setState({ foundedDate: e.target.value });
};
setDescription = e => {
        ...
        <div className="login-form-div" />
            <Row>
                ...
                <Col lg="5" className="text-center text-md-right">
                    <div className="login-form-div">
                        <CompanyNameInput onChange={this.setCompanyName} placeholder={this.state.company.companyName}  style={{width: 300}}/>
                    </div>
                </Col>
            </Row>
            <Row>
...
onClickSubmit = e => {
    e.preventDefault();
        ...
        const { companyName, foundedDate, description} = this.state;
        let body = {
