...
export const clearRecommendations = {
    request: () => action(CLEAR_RECOMMENDATIONS.REQUEST, {}),
    success: response => action(CLEAR_RECOMMENDATIONS.SUCCESS, { response }),
    failure: error => action(CLEAR_RECOMMENDATIONS.FAILURE, { error })
}